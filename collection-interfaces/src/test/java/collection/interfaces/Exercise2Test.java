...
public class Exercise2Test {
    ...
    public void mergeValues() {
         ...
         */
        BiFunction<Object, Object, Integer> remappingFunction = (oldValue, newValue) -> (Integer) oldValue + (Integer) newValue;
        map.merge("Alice", 32, remappingFunction);
        map.merge("Joe", 32, remappingFunction);
        //map.merge第一个参数是key，第二个是value，如果key不存在直接put，否则对原来的值和新值应用remappingFunction，计算结果放入map
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<Object, Object, Integer> remappingFunction = (key, value) -> (Integer) value + 1;
        ...
        //map.computeIfPresent的remappingFunction第一个参数是key，第二个参数是value
